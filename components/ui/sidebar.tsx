  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            'duration-200 fixed top-[var(--navbar-height)] bottom-0 z-10 hidden h-[calc(100vh-var(--navbar-height))] w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex',
            side === 'left'
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        'absolute z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear after:absolute after:top-[var(--navbar-height)] after:bottom-0 after:left-1/2 after:w-[2px] hover:after:bg-sidebar-border group-data-[side=left]:-right-4 group-data-[side=right]:left-0 sm:flex',
